...
%.lp
\item[\ib{invweight}]
When enabled, show per-inventory-line weights (stacks show total weight)
in inventory/menu displays; default is off.  This can be toggled interactively
from the inventory menu (press `W' in inventory).  Persistent.
%.lp
