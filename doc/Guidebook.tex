...
The command brings up a submenu.  Besides the usual naming choices it
also lets you open the intrinsic tracker (press `\tt I') or the
personal notes manager (press `\tt N' again) without typing their full
commands.
%.lp
\item[\tb{\#offer}]
