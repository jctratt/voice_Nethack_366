...
/* reset random-monster notification guard used during level generation */
E void FDECL(rndmon_msg_play_if_pending, (void));
...
E const char *FDECL(mon_eaten_intrinsics, (int));
...
E int FDECL(innate_prop_level, (int));
